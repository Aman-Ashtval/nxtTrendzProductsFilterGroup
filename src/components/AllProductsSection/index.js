...
class AllProductsSection extends Component {
  ...
  noProductView = () => (
    <div className="failure-container">
      ...
      />
      <h1 className="failed-h1">No Products Found</h1>
      <p className="failed-p">We could not find products. Please try again</p>
    </div>
  )
